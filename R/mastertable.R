...
res2034 <- sqlQuery(dbhandle, 'SELECT AnalogSignalValues, DateTime
                ...
                WHERE PK_Vehicle = 2 AND PK_DinGroup = 2034 AND Description_L1=\'Daten Allgemein\' ')

din2034 <- within(res2034, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2035
...
din2035 <- within(res2035, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2036
...
din2036 <- within(res2036, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2037
...
din2037 <- within(res2037, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2038
...
din2038 <- within(res2038, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2039
...
din2039 <- within(res2039, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2040
...
din2040 <- within(res2040, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2041
...
din2044 <- within(res2044, AnalogSignalValues<-data.frame(do.call('rbind', lapply(strsplit(as.character(AnalogSignalValues), ';', fixed=TRUE), as.numeric))))
#2045
...
Vars <- colnames(din2034$AnalogSignalValues)
Namen <- c("X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2034$AnalogSignalValues <- din2034$AnalogSignalValues[, !(Vars %in% Namen)]

Vars <- colnames(din2035$AnalogSignalValues)
Namen <- c("X4", "X5", "X6", "X7", "X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2035$AnalogSignalValues <- din2035$AnalogSignalValues[, !(Vars %in% Namen)]

Vars <- colnames(din2036$AnalogSignalValues)
Namen <- c("X4", "X5", "X6", "X7", "X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2036$AnalogSignalValues <- din2036$AnalogSignalValues[, !(Vars %in% Namen)]

Vars <- colnames(din2037$AnalogSignalValues)
Namen <- c("X6", "X7", "X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2037$AnalogSignalValues <- din2037$AnalogSignalValues[, !(Vars %in% Namen)]

Vars <- colnames(din2038$AnalogSignalValues)
Namen <- c("X3", "X4", "X5", "X6", "X7", "X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2038$AnalogSignalValues <- din2038$AnalogSignalValues[, !(Vars %in% Namen)]

Vars <- colnames(din2039$AnalogSignalValues)
Namen <- c("X4", "X5", "X6", "X7", "X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2039$AnalogSignalValues <- din2039$AnalogSignalValues[, !(Vars %in% Namen)]

Vars <- colnames(din2040$AnalogSignalValues)
Namen <- c("X4", "X5", "X6", "X7", "X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2040$AnalogSignalValues <- din2040$AnalogSignalValues[, !(Vars %in% Namen)]

Vars <- colnames(din2044$AnalogSignalValues)
Namen <- c("X8", "X9", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "X17", "X18", "X19", "X20")
din2044$AnalogSignalValues <- din2044$AnalogSignalValues[, !(Vars %in% Namen)]
...
colnames(din2034$AnalogSignalValues)[1] <- "Dieselfüllstand"
colnames(din2034$AnalogSignalValues)[2] <- "Frischwassertank"
colnames(din2034$AnalogSignalValues)[3] <- "Batterie 1/2 Spannung"
colnames(din2034$AnalogSignalValues)[4] <- "Batterie 3 Spannung"
colnames(din2034$AnalogSignalValues)[5] <- "Batterie 4 Spannung"
colnames(din2034$AnalogSignalValues)[6] <- "Batterie 1/2 Strom"
colnames(din2034$AnalogSignalValues)[7] <- "Batterie 3 Strom"
colnames(din2035$AnalogSignalValues)[1] <- "Drehzahl M1"
colnames(din2035$AnalogSignalValues)[2] <- "Kühlmitteltemp M1"
colnames(din2035$AnalogSignalValues)[3] <- "Öldruck M1"
colnames(din2036$AnalogSignalValues)[1] <- "Drehzahl M2"
colnames(din2036$AnalogSignalValues)[2] <- "Kühlmitteltemp M2"
colnames(din2036$AnalogSignalValues)[3] <- "Öldruck M2"
colnames(din2037$AnalogSignalValues)[1] <- "Betriebsstund. M1"
colnames(din2037$AnalogSignalValues)[2] <- "Betriebsstund. M2"
colnames(din2037$AnalogSignalValues)[3] <- "Betriebsstund. Kran1"
colnames(din2037$AnalogSignalValues)[4] <- "Betriebsstund. Kran2"
colnames(din2037$AnalogSignalValues)[5] <- "Betriebsstund. Kran3"
colnames(din2038$AnalogSignalValues)[1] <- "Hydrauliköltank Füllstand"
colnames(din2038$AnalogSignalValues)[2] <- "Hydrauliköl Temp"
colnames(din2039$AnalogSignalValues)[1] <- "Getr. Arbeits. Fahrdruck A"
colnames(din2039$AnalogSignalValues)[2] <- "Getr. Arbeits. Fahrdruck B"
colnames(din2039$AnalogSignalValues)[3] <- "Getr. Arbeits. Speisedruck"
colnames(din2040$AnalogSignalValues)[1] <- "Partikelf. Regenerationh"
colnames(din2040$AnalogSignalValues)[2] <- "Partikelf. Filterwiderstand"
colnames(din2040$AnalogSignalValues)[3] <- "Partikelf. Regenerations"
colnames(din2044$AnalogSignalValues)[1] <- "Getr. Überst. Öltemp. 1"
colnames(din2044$AnalogSignalValues)[2] <- "Getr. Überst. Öltemp. 2"
colnames(din2044$AnalogSignalValues)[3] <- "Getr. Überst. Retarder1"
colnames(din2044$AnalogSignalValues)[4] <- "Getr. Überst. Retarder2"
colnames(din2044$AnalogSignalValues)[5] <- "Getr. Überst. Fahrdruck A"
colnames(din2044$AnalogSignalValues)[6] <- "Getr. Überst. Fahrdruck B"
colnames(din2044$AnalogSignalValues)[7] <- "Getr. Überst. Speisedruck"
