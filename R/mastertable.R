...
dbhandle <- odbcDriverConnect('driver={SQL Server};server=KLAPPRECHNER;database=ConcertoDb_TIF_WA6358_59_b9500bbf-f52a-474a-92c5-b863ed31d004;trusted_connection=true')
